  ...
  <body class="gradient leading-relaxed tracking-wide flex flex-col">
    ...
    <div class="container mx-auto h-screen">
      <div class="text-center px-3 lg:px-0">
        ...
        >
          Emita comprobantes. ¡Donde sea cuando sea! 
        </h1>
        <p
          class="leading-normal text-gray-800 text-base md:text-xl lg:text-2xl mb-8"
        >
          La emisión de Comprobantes de Pagos Electrónicos en línea fácil e intuitiva le ayudará a su empresa a verse ¡profesional y mantenerse organizada! 
        </p>
...
<img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiR-UpUWoBgjfRXxpWmL-GFVRecQDJB5ZNnf28mnnB9qFQv8TxJAbc9zIq0Emi-IVBKP7SuObHiSX4KNVnuTHinv7t0PgggJUk7yklVFBkBIeNkhHc9OQ8rlfqihg5NpSe6K0GE57TpUb8hAB7xudnewVUlmDudFSMe0woJYRMk-CW_izGyH-bkdXvisRs6/s1600/images%281%29copiadfgdf_copy_607x505.jpg" alt="Texto alternativo">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
              El sistema SEE - RAYO sirve para 
              Emitir Comprobantes de Pago y Documentos relacionados 
              a un coste gratuito y auténtico.<br /><br />
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                Esenciales globalmente
              </h3>
              <p class="text-gray-600 mb-8">
                Debido a su eficiencia, reducción de costos, sostenibilidad ambiental y facilitación de transacciones comerciales, 
                agilizando procesos y mejorando la precisión en registros financieros. <br /><br />
    ...
    <section class="bg-white border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          >
            <a href="index.php?p=factura" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-600 text-base px-6 mb-5">
                Si tienes un negocio o empresa, debes emitir una factura electrónica para sustentar costo, 
                gasto y crédito fiscal en tu declaración anual.
              </p>
            </a>
          </div>
          <div
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div
            class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow"
          >
            <a href="index.php?p=boleta" class="flex flex-wrap no-underline hover:no-underline">
              <p class="w-full text-gray-600 text-xs md:text-sm px-6 mt-6">
                COMIENCE A EMITIR
              </p>
              <div class="w-full font-bold text-xl text-gray-800 px-6">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div
            class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow"
          >
            <a href="index.php?p=recibo" class="flex flex-wrap no-underline hover:no-underline">
              <p class="w-full text-gray-600 text-xs md:text-sm px-6 mt-6">
                COMIENCE A EMITIR
              </p>
              <div class="w-full font-bold text-xl text-gray-800 px-6">
